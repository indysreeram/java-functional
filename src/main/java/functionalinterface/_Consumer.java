...
public class _Consumer {
    ...
    public static void main(String[] args) {
        ...
        //Bi Consumer Function interface

        greetCustomerV2(sreeram,true);
        greetCustomerV2(sreeram,false);
        greetCustomerConsumerV2.accept(sreeram,true);
        greetCustomerConsumerV2.accept(sreeram,false);
